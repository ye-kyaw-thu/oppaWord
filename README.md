...
oppaWord ဆိုတဲ့ နာမည်လား။ အစက ARPA LM ကို သုံးထားတာမို့လို့ arpaWord ဆိုပြီး နာမည်ပေးဖို့ စဉ်းစားခဲ့တာ။ တကယ်တမ်းက hybrid_dag_bimm_lm.py ဆိုပြီး ပေးရင်တော့ သုံးထားတဲ့ approach အားလုံးလိုလိုကို ခြုံငုံမိပါတယ်။ ခက်တာက အများအတွက် မှတ်မိဖို့ ခက်ပါလိမ့်မယ်။ လက်ရှိ ကိုရီးယား စကားလုံး [oppa](https://en.wiktionary.org/wiki/%EC%98%A4%EB%B9%A0) (오빠) ဆိုရင်တော့ မြန်မာလူငယ်တိုင်းလိုလို ရင်းနှီးပြီးသား ဖြစ်ပါလိမ့်မယ်။ ပြီးတော့ ၁၀တန်းအပြီးမှာ နှစ်တော်တော်ကြာကြာ တိုက်ကွမ်ဒိုအားကစားကို လုပ်ဖြစ်ခဲ့တဲ့ ငယ်ဘဝ အမှတ်တရတွေရယ်၊ ကျွန်တော်ရဲ့ တိုက်ကွမ်ဒိုဆရာတွေအများကြီးထဲကတစ်ဦးဖြစ်တဲ့ ကမ္ဘာ့ချန်ပီယံ ဆရာဂျွန် ကိုလည်း သတိရတာနဲ့ oppaWord လိုပဲ နာမည်ပေးဖြစ်ခဲ့ပါတယ်။  
